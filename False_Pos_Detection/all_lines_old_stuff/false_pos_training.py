...
model.add(Dense(183, activation = "tanh", kernel_initializer='random_normal'))
model.add(Dense(37, activation = "tanh", kernel_initializer='random_normal'))
