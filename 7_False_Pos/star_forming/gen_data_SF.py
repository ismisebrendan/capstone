...
spec = Spectrum('../lines_in_SF.txt', '../fitting_SF.txt', Nsim=Nsim)
...
files_present = [f for f in os.listdir() if os.path.isfile(os.path.join(".", f)) and f[:9] == "star_form" and f[-4:] == ".txt"]
file_out = f'star_form{len(files_present)}.txt'
