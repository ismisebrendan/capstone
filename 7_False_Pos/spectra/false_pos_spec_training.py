...
model = Sequential()
model.add(Dense(719, activation = "tanh", kernel_initializer='random_normal'))

#Adding hidden layers
model.add(Dense(3000, activation = "tanh", kernel_initializer='random_normal'))
model.add(Dense(1400, activation = "tanh", kernel_initializer='random_normal'))
